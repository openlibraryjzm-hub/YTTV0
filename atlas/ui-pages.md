...
#### ### 4.1.0 Home Hub (Mission Control)
...
- `src/store/missionStore.js`: State management.
...
---
#### ### 4.1.8.1 Dedicated Settings Pages

The Settings Page navigation hub provides access to four dedicated configuration pages. Each page has its own comprehensive documentation:

- **OrbPage**: See `orb-page.md` for complete Orb configuration documentation
  - Orb image and spill configuration
  - Preset management with folder assignments
  - Group leader system for organizing presets

- **YouPage**: See `you-page.md` for complete Profile & Signature documentation
  - User name/pseudonym configuration
  - ASCII signature/avatar editor
  - Preview system

- **PagePage**: See `page-page.md` for complete Page Banner & Layer 2 documentation
  - Group leader theme system (replaces legacy folder theme)
  - Layer 2 image library and folder management
